...
// Generated by Core Animator version 1.1.1 on 8/15/15.
//
...
class SampleGameScreenDynamicView : UIView {
	...
	func setupHierarchy() {
		...
		let fullBackground = UIView()
		fullBackground.bounds = CGRect(x:0, y:0, width:2208.2, height:1256.2)
		fullBackground.layer.position = CGPoint(x:1104.103, y:628.091)
		__scaling__.addSubview(fullBackground)
		viewsByName["Full_Background"] = fullBackground
		...
		fullBackground.addSubview(background)
		viewsByName["Background"] = background

		let gameFrame = UIImageView()
		gameFrame.bounds = CGRect(x:0, y:0, width:3336.0, height:2370.0)
		...
		gameFrame.image = imgGameFrame
		gameFrame.contentMode = .Center;
		gameFrame.layer.position = CGPoint(x:1104.103, y:663.683)
		gameFrame.transform = CGAffineTransformMakeScale(0.50, 0.50)
		fullBackground.addSubview(gameFrame)
		viewsByName["Game Frame"] = gameFrame
		...
		fullBackground.addSubview(blocks)
		...
		let lowerTab = UIImageView()
		lowerTab.bounds = CGRect(x:0, y:0, width:1888.0, height:234.0)
		var imgLowerTab: UIImage!
		if let imagePath = bundle.pathForResource("Lower Tab.png", ofType:nil) {
			imgLowerTab = UIImage(contentsOfFile:imagePath)
		}
		lowerTab.image = imgLowerTab
		lowerTab.contentMode = .Center;
		lowerTab.layer.position = CGPoint(x:1104.000, y:1146.594)
		lowerTab.transform = CGAffineTransformMakeScale(0.50, 0.50)
		__scaling__.addSubview(lowerTab)
		viewsByName["Lower Tab"] = lowerTab
